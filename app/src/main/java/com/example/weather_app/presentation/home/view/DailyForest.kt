    ...
    @Composable
    fun DailyForecast(dailyData: DailyForecastResponse, unit:String) {
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    @Composable
    fun DailyForecastCard(data: DailyForecastItem, unit:String) {
        ...
        Card(
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = formatToDate(data.dt, context = context),
                        color = Color.White,
                        fontSize = 14.sp,
